...
static const int64 MAX_MONEY = 91000000 * COIN; // GlobalTourCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 0.25) / 250; // GlobalTourCoin: Priority cutoff is 2 GlobalTourCoin day / 250 bytes.
    }
